# d2-net/megadepth_utils/preprocess_scene.py
...
"""
sample usage
python preprocess_scene.py --base_path "/media/cviss3/Expansion/LoFTR_our_data/dummy_struct/" --scene_id gardiner_210606 --output_path /media/cviss3/Expansion/LoFTR_our_data/dummy_struct
"""

parser = argparse.ArgumentParser(description='MegaDepth-like preprocessing script')
